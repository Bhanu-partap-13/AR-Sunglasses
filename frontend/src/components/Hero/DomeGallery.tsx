...
// Sunglasses images for the gallery
const SUNGLASSES_IMAGES: ImageItem[] = [
  {
...
export default function DomeGallery({
  ...
  }, [lockScroll, unlockScroll, segments, enlargeTransitionMs, openedImageWidth, openedImageHeight]);
